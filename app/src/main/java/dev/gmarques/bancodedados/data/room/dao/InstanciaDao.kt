...
import dev.gmarques.bancodedados.data.entidades.relacoes.InstanciaComCampos
...
abstract class InstanciaDao : BaseDao<InstanciaEntidade>() {
    ...
    suspend abstract fun getInstanciasComCampos(templateUid: String): List<InstanciaComCampos>
